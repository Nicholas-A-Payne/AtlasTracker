...
namespace AtlasTracker.Data.Migrations
{
    ...
    [Migration("20220302183441_initial_AT0001")]
    partial class initial_AT0001
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasTracker.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("AtlasTracker.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AtlasTracker.Models.TicketAttatchment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppUserProject", b =>
                {
                    b.HasOne("AtlasTracker.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("AtlasTracker.Models.AppUser", "Invitor")
                        .WithMany()
                        .HasForeignKey("InvitorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.Project", "Projects")
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasTracker.Models.Notification", b =>
                {
                    b.HasOne("AtlasTracker.Models.NotificationType", "NotificationType")
                        .WithMany()
                        .HasForeignKey("NotificationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.AppUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("AtlasTracker.Models.AppUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.Ticket", "Tickets")
            ...
            modelBuilder.Entity("AtlasTracker.Models.Ticket", b =>
                {
                    b.HasOne("AtlasTracker.Models.AppUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("AtlasTracker.Models.AppUser", "OwnerUser")
                        .WithMany()
                    ...
                    b.HasOne("AtlasTracker.Models.TicketPriority", "TicketPriority")
                        .WithMany()
                        .HasForeignKey("TicketPriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.TicketStatus", "TicketStatus")
                        .WithMany()
                        .HasForeignKey("TicketStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasTracker.Models.TicketType", "TicketTypes")
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasTracker.Models.TicketAttatchment", b =>
                {
                    ...
                    b.HasOne("AtlasTracker.Models.AppUser", "User")
                        .WithMany()
