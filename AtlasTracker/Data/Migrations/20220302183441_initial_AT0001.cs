    ...
    public partial class initial_AT0001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketAttatchments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketAttatchments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketAttatchments_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAttatchments_TicketId",
                table: "TicketAttatchments",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketAttatchments_UserId",
                table: "TicketAttatchments",
                column: "UserId");
